<template>
  <v-card id="joinCard" class="pa-8" light width="900" max-height="650" style="top: 32px">
    ...
    <v-form>
      ...
      <!-- 이름 -->
      <label>이름</label>
      <v-text-field v-model="name" type="text" outlined placeholder="ex) 홍길동"></v-text-field>
      <!-- 연락처 -->
      <label>연락처</label>
      <v-text-field v-model="phoneNumber" outlined placeholder="ex) 010-1234-5678"></v-text-field>
