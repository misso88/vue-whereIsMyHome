<template>
  <v-card class="pa-8" light width="500">
    ...
    <form>
      <v-text-field class="mb-5" v-model="member.emailId" placeholder="ssafy@ssafy.com" outlined hide-details></v-text-field>
      <v-text-field v-model="member.pass" placeholder="비밀번호" outlined hide-detail type="password"s></v-text-field>
