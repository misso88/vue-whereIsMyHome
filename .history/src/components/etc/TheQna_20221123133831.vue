      ...
      <v-dialog v-model="dialog" persistent max-width="600px">
        ...
        <v-card height="500px">
          ...
          <v-form class="ma-8">
            ...
            <small class="grey">최대한 빠르고 친절하게 답변드리겠습니다.</small>
            <v-row justify="end" class="pa-4">
              <v-btn color="primary" large @click="dialog = false"> 등록 </v-btn>
              <v-btn color="primary" large @click="dialog = false"> 취소 </v-btn>
            </v-row>
          </v-form>
        </v-card>
      </v-dialog>
